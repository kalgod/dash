...
PROFILE_CUSTOM="-b:v:0 200K -s:v:0 640x360 -b:v:1 600K -s:v:1 852x480 -b:v:2 1000K -s:v:2 1280x720 -b:v:3 2500K -s:v:3 1920x1280 -b:v:4 4000K -s:v:4 2560x1440 -map 0:v:0 -map 0:v:0 -map 0:v:0 -map 0:v:0 -map 0:v:0 -bufsize 200K -adaptation_sets id=0,seg_duration=0.5,streams=0,1,2,3,4"
PROFILE_CUSTOM1="-b:v:0 200K -s:v:0 320x180 -bufsize:v:0 400K -b:v:1 600K -s:v:1 480x270 -bufsize:v:1 1200K -b:v:2 1000K -s:v:2 640x360 -bufsize:v:2 2000K -b:v:3 2500K -s:v:3 1024x576 -bufsize:v:3 5000K -b:v:4 4000K -s:v:4 1280x720 -bufsize:v:4 8000K -b:v:5 6000K -s:v:5 1920x1080 -bufsize:v:5 12000K -map 0:v:0 -map 0:v:0 -map 0:v:0 -map 0:v:0 -map 0:v:0 -map 0:v:0 -adaptation_sets id=0,seg_duration=0.5,streams=0,1,2,3,4,5"
...
elif [ "$PROFILE" == "PROFILE_CUSTOM1" ]
then
    LADDER_PROFILE=$PROFILE_CUSTOM1
    echo "Using custom1 ffmpeg profile"
else
...
-re -stream_loop -1 -i bbb_30fps_1920x1080_8000k.mp4 \
-c:v ${VCODEC} \
${LADDER_PROFILE} \
-use_timeline 0 \
-use_template 1 \
...
echo "${FF} -hide_banner -loglevel panic \
-re -stream_loop -1 -i bbb_30fps_1920x1080_8000k.mp4 \
-c:v ${VCODEC} \
${LADDER_PROFILE} \
-use_timeline 0 \
