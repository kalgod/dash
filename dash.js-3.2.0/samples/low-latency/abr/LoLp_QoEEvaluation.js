...
class QoeEvaluator {
    ...
    createQoeInfo(fragmentType, fragmentDuration, maxBitrateKbps, minBitrateKbps) {
        ...
        qoeInfo.weights.bitrateSwitchPenalty = 0.1;
        ...
        qoeInfo.weights.latencyPenalty.push({ threshold: 1.5, penalty: (minBitrateKbps * 0.05) });
    ...
    logMetricsInQoeInfo(bitrate, rebufferTime, latency, playbackSpeed, qoeInfo) {
        ...
        // console.log(bitrate, rebufferTime, latency, playbackSpeed, qoeInfo)
